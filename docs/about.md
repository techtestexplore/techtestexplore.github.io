...
hero:
  name: About
  text: 
  tagline: 👉Wuhao，🍎iOS Developer，🧭当前位置：上海，🔥喜欢写代码，看电影，打篮球，打游戏
  actions:
    - theme: brand
      text: 📱 记录Box
    ...
    - theme: alt
      text: 📱 HabBox
      link: https://apps.apple.com/cn/app/id6446240226
...
features:
  ...
  - icon:
      src: assets/justtest/github.svg
    title: Github
    link: https://github.com/remember17

  - icon:
      src: ../assets/justtest/twitter.svg
    title: Twitter
    link: https://twitter.com/areahao

  - icon:
      src: /assets/justtest/weibo.svg
    title: Weibo
